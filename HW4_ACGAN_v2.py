...
from HW4_ACGAN_Supp import Generator
from HW4_ACGAN_Supp import Discriminator
from HW4_ACGAN_Supp import train
from HW4_ACGAN_Supp import evaluateFID
...
if __name__ == '__main__':
    ...
    train(G, D, training_data, device, epochs=100, noise_dim=50, cond_dim=10)
